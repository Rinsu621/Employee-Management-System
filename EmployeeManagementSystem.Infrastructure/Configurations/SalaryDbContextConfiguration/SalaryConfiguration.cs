...
namespace EmployeeManagementSystem.Infrastructure.Configurations.SalaryDbContextConfiguration
{
    public class SalaryConfiguration : IEntityTypeConfiguration<EmployeeManagementSystem.Domain.Entities.Salary>
    {
