...
{
    public class AuthIntegrationTests:IClassFixture<EmployeeManagementSystemWebApplicationFactory>
    {
        private readonly EmployeeManagementSystemWebApplicationFactory _factory;
        private readonly HttpClient _httpClient;
        private readonly ITestOutputHelper _output;
        private readonly IServiceScope _scope;
        private readonly IMediator _mediator;

        public AuthIntegrationTests(EmployeeManagementSystemWebApplicationFactory factory, ITestOutputHelper output)
        {
            _factory = factory;
