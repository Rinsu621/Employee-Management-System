...
using EmployeeManagementSystem.Application.ProjectModule.Commands;
...
{
    public class ProjectIntegationTests:IClassFixture<EmployeeManagementSystemWebApplicationFactory>
    {
        ...
        public ProjectIntegationTests(EmployeeManagementSystemWebApplicationFactory _factory, ITestOutputHelper _output)
        {
            factory = _factory;
