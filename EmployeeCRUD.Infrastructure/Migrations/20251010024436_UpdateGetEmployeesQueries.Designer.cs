...
namespace EmployeeCRUD.Infrastructure.Migrations
{
    ...
    [Migration("20251010024436_UpdateGetEmployeesQueries")]
    partial class UpdateGetEmployeesQueries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EmployeeCRUD.Domain.Entities.ApplicationUser", b =>
                {
                    b.HasOne("EmployeeCRUD.Domain.Entities.Employee", "Employee")
                        .WithOne("User")
                        .HasForeignKey("EmployeeCRUD.Domain.Entities.ApplicationUser", "EmployeeId")
