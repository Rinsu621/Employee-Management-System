...
export const exportProfileToPdf = (payload) => {
  return api.post('/employee/export/profile-pdf', payload, {
    responseType: 'blob'
  })
};

export const exportUserTableToPdf = (payload) => {
  return api.post('/employee/export/table-pdf', payload, {
    responseType: 'blob'
  })
};
